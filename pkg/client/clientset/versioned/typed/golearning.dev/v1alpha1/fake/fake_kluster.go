...
type FakeKlusters struct {
	Fake *FakeGolearningV1alpha1
	ns   string
}

var klustersResource = schema.GroupVersionResource{Group: "golearning.dev", Version: "v1alpha1", Resource: "klusters"}

var klustersKind = schema.GroupVersionKind{Group: "golearning.dev", Version: "v1alpha1", Kind: "Kluster"}
