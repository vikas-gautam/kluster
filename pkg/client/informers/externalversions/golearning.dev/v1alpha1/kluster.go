...
import (
	...
	golearningdevv1alpha1 "github.com/vikas-gautam/kluster/pkg/apis/golearning.dev/v1alpha1"
	versioned "github.com/vikas-gautam/kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/vikas-gautam/kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/vikas-gautam/kluster/pkg/client/listers/golearning.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GolearningV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GolearningV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&golearningdevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&golearningdevv1alpha1.Kluster{}, f.defaultInformer)
}
